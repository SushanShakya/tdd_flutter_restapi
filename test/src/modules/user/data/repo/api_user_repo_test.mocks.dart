...
// in tdd_demo/test/src/modules/user/data/repo/api_user_repo_test.dart.
...
class _FakeHeaders_5 extends _i1.Fake implements _i7.Headers {}
...
class MockResponse<T> extends _i1.Mock implements _i6.Response<T> {
  ...
  _i7.Headers get headers => (super.noSuchMethod(Invocation.getter(#headers),
      returnValue: _FakeHeaders_5()) as _i7.Headers);
  @override
  ...
  List<_i11.RedirectRecord> get redirects =>
      (super.noSuchMethod(Invocation.getter(#redirects),
          returnValue: <_i11.RedirectRecord>[]) as List<_i11.RedirectRecord>);
  @override
  set redirects(List<_i11.RedirectRecord>? _redirects) =>
